    ...
    companion object {
        ...
        fun caretPositionProvider(): Stream<Arguments> =
            Stream.of(
                ...
                Arguments.of(LogicalPosition(3, 9), "d2l", LogicalPosition(1, 0)),
                // Delete down - caret moves to start of current line
                Arguments.of(LogicalPosition(3, 9), "d2k", LogicalPosition(3, 0)),
                ...
                Arguments.of(LogicalPosition(5, 9), "d2,1l", LogicalPosition(3, 9)),
                // Delete below the current line - caret remains unchanged
                Arguments.of(LogicalPosition(3, 9), "d1,2k", LogicalPosition(3, 9)),
            )
    }
